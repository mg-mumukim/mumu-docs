# collaboration-in-ai-first-teams

## Observations
### 2026-04-13
- Collaboration rituals come in many forms: meetings (progress check, proposal, knowledge sharing, discussion, decision making) and review ceremonies (code review, design review).

## Questions
### 2026-04-13
- In an AI-first org where agents do much of the execution, what should humans communicate to each other, and how?
