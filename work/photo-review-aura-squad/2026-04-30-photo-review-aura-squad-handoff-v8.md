...
| Cooldown: 1 day for Segment 1 (6+ photos); 0 days for Segment 2 (<6 photos) | Jaini Shah | Adopted (4/29) | Both backend configurable. Segment 2 excluded from cooldown so users can receive updated insight immediately after adding a photo toward count goal. |
