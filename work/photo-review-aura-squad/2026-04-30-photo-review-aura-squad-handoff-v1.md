# Photo Review AURA Squad — Handoff v1
...
| Source | Anchor |
|---|---|
| Slack | #mgai-aura (C06FB511ZRR); #ml-photo-review (C0AMBBQGU6R — not accessible via MCP) |
...
|---|---|---|---|
| WI-01 | rSRR predictor report shared with Trideep | Biggie | Done |
...
1. **Bottom sheet dismiss policy**: Jaini logged as open question at Apr 28 Spec Kick-off (transcript line 391). Engineering suggestion is full opt-out for MVP; PM ratification pending from Jaini/Juniper.
