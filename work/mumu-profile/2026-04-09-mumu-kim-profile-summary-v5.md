...
### Notion (hpcnt workspace)

Primary documentation platform for MG AI. Mumu actively uses Notion for:

**Authored / Maintained pages:**

| Page | Purpose |
|------|---------|
| Mumu's Thoughts | Personal thought dump and decision log |
| MG AI Onboarding | Team onboarding guide |
| MGAI PM-TL Sync (Juniper) | Regular PM-TL sync meeting notes |
| AURA x GenAI sync | Cross-team sync meeting notes |
| MGAI Dev Weekly | Weekly engineering team meeting notes |
| Feature Forum leadership/exec preparation | Tinder leadership presentation prep |
| Tinder on-site (photo review MVP) debrief | Onsite debrief and action items |
| Camera roll scan v2 on-device model training (2025-12) | Training experiment log and results |
| camera-roll-scan-v2-android (2025-10) | Android benchmark and device testing |
| Insight matching model US traffic (2025-08) | Latency optimization documentation |
| Photo Finder v3 Gradio labeling tool | Evaluation tool documentation |
| Input schema ML | ML model input/output contract |

**Meeting notes / 1-on-1s:**

| Page | Participants |
|------|-------------|
| Mumu / Juniper 1+1=3 | PM-TL collaboration planning |
| Mumu / Jaeger | Chemistry squad sync |
| Chemistry jaeger/harriet/mumu | Chemistry leadership coordination |

**Retrospectives:**

- Chemistry Camera Roll M2-M3 retrospective (initiated by Harriet, Mumu participated)
- Explanation v2 / CRS V2 retrospective (topic voting, facilitated discussion)

**Documentation habits (from Slack observations):**

- Shares Notion links proactively in Slack threads as SSOT references
- Advocates for visibility in Notion docs: recommends per-person status indicators, checkbox tracking
- Coaches team on documentation practices: "status, due date, contents -- make everything visible and true"
- Uses Notion meeting notes as action item tracking, posts summaries back to Slack
- Cross-references Notion with Google Docs and Jira -- Notion for internal, Google Docs for cross-team with Tinder stakeholders
